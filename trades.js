...
window.SITE_DATA = {
  ...
  trades: [
    { ticker:"GOOGL", direction:"SHORT", dateOpened:"2026-07-16", entry:355.5, close:351.99, stop:366.5, t1:340, t2:328, t1Hit:false, t2Hit:false, result:"open", isNew:false },
    { ticker:"MSFT", direction:"SHORT", dateOpened:"2026-07-06", entry:397, close:402.29, stop:408.5, t1:385, t2:372, t1Hit:true, t1Date:"2026-07-08", t2Hit:false, result:"open", isNew:false },
    { ticker:"SPY", direction:"LONG", dateOpened:"2026-07-06", entry:748, close:742.21, stop:733.5, t1:760.4, t2:773, t1Hit:false, t2Hit:false, result:"open", isNew:false },
    { ticker:"UNH", direction:"LONG", dateOpened:"2026-06-26", entry:416.5, close:421.55, stop:389, t1:430, t2:445, t1Hit:true, t1Date:"2026-07-09", t2Hit:false, result:"open", isNew:false },
    { ticker:"MU", direction:"SHORT", dateOpened:"2026-07-17", entry:853, close:865.46, stop:925, t1:790, t2:752, t1Hit:false, t2Hit:false, result:"open", isNew:true },
  ],
  closedTrades: [
  ...
  watchlist: [
    { ticker:"NVDA", side:"SHORT", state:"ARMED", close:203.28, level:199, stop:211.63, t1:189, t2:182 },
    { ticker:"META", side:"SHORT", state:"ARMED", close:645.85, level:572.5, stop:593, t1:547.5, t2:536 },
    { ticker:"AAPL", side:"SHORT", state:"ARMED", close:326.59, level:287.3, stop:295.5, t1:280, t2:273 },
    { ticker:"AMZN", side:"LONG", state:"ARMED", close:249.99, level:254, stop:246.5, t1:261, t2:268.5 },
    { ticker:"NFLX", side:"LONG", state:"ARMED", close:67.6, level:85.8, stop:82.3, t1:88.6, t2:91.3 },
    { ticker:"TLT", side:"SHORT", state:"ARMED", close:83.89, level:82.6, stop:84, t1:80.7, t2:79 },
  ]
};
